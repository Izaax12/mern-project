...
export default function DashProfile() {
    ...
    const uploadImage = async() =>{
       ...
       uploadTask.on(
        ...
        (error) => {
            setImageFileUploadError('Error al subir imagen (La imagen debe ser menor a 2MB)');
    ...
    const handleSubmit = async (e) => {
        ...
        if(imageFileUploading){
            setUpdateUserError('Porfavor espera a que la imagen se cargue');
            return;
        }
        try {
            ...
            if(!res.ok){
                ...
                setUpdateUserSuccess("Se actualizo el perfil del usuario correctamente");
            }
        } catch (error) {
        ...
        <Modal show={showModal} onClose={()=>setShowModal(false)} popup size='md'>
            ...
            <Modal.Body>
                <div className='text-center'>
                    ...
                    <h3>Estas seguro que quieres eliminar esta cuenta?</h3>
                    <div className='flex justify-center gap-4'>
                        <Button color='failure' onClick={handleDeleteUser}>Si</Button>
